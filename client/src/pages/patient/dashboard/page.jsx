...
import patientImage from "../../../assets/patient dash.png"; // Import the image
...
function PatientDashboard() {
  ...
  useEffect(() => {
    ...
    // Ensure data exists in localStorage before parsing
    if (data) {
  ...
  useEffect(() => {
    ...
    return () => {
      socket.off("patient:message");
    };
  }, [socket]);

  function call() {
    // Ensure patient data exists before emitting the request
    if (patient && patient.id) {
      ...
      console.error("Patient data is incomplete.");
    }
  }
